     ...
     <c:if test="${count1>0 }">
		...
		<main class="container lnb page my" id="container">
			<div class="inr" style="min-height: 482.097px;">			
			      ...
			      <!-- 등록한 카드 반복 구간 -->
			      <c:forEach var="cddto" items="${lists1 }">
			         <div class="list-item card">
			                 <div class="thumbnail-area">
			                     <div class="thumbnail"><img src="upload/${cddto.saveName }" alt="${cddto.cardName }"></div>
			                 </div>
			                 <div class="description">
			                     <h4 class="name">${cddto.cardName}</h4> <a href="/zzimonClick.do?categoryName=${categoryName }&num=${cddto.num}"><i class="far fa-bookmark"></i></a>
			                     <a href="/WishList.do?num=${cddto.num}"><i class="fas fa-shopping-cart"></i></a>	
			                     <ul class="info-list">
